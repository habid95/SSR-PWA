...
export const CustomForm = ({ title, formData, register, errors, aling, alingLabel }) => {
          ...
          <div className="flex items-center space-x-2">
            {
              field.label &&
              (
                <label className={`block text-sm ${alingLabel} w-full`}>{field.label}</label>
              )
            }
            ...
            <input
              ...
              className={` w-3/5 ${aling} bg-transparent focus:ring-0 focus:outline-none ${
