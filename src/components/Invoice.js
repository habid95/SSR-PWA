...
export const Invoice = () => {
  return (
    <div className='bg-[#192733] text-white text-left md:text-center min-h-40 font-medium flex flex-col justify-center px-6 py-8 md:px-36 md:py-16'>
        <h1 className='text-5xl pb-4 font-bold md:pb-9'>
            Invoice Generator
        </h1>
